	...
	public static void main(String[] args) {
		...
		if(userName.equals("Omer") && password.equals(passwordLogin)){
			...
			case 1:
				...
				String newPassword = inp.next();// Esra arkadaþýmýn ödevinden aldým. Veritipi olarak tanýmlamayarak hem string hem de int olarak veri atayabilmek için.
												// Ayrýca if döngüsünde int veri tipiyle stringi ayný anda kabul etmiyor.
			...
			case 2:
				...
				default:
					System.out.print("Ýstenen degerlerden birini seciniz.");
